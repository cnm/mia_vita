    ...
    IN BOOLEAN		 bLinkUp)
{
    ...
    for (i=0; i<SupRateLen; i++)
    {
        ...
        case 2:
            Rate = RATE_1;
            if (pSupRate[i] & 0x80) BasicRateBitmap |= 0x0001;
            break;
        case 4:
            Rate = RATE_2;
            if (pSupRate[i] & 0x80) BasicRateBitmap |= 0x0002;
            break;
        case 11:
            Rate = RATE_5_5;
            if (pSupRate[i] & 0x80) BasicRateBitmap |= 0x0004;
            break;
        case 22:
            Rate = RATE_11;
            if (pSupRate[i] & 0x80) BasicRateBitmap |= 0x0008;
            break;
        case 12:
        ...
        case 18:
            Rate = RATE_9;
            if (pSupRate[i] & 0x80) BasicRateBitmap |= 0x0020;
            break;
        case 24:
        ...
        case 36:
            Rate = RATE_18;
            if (pSupRate[i] & 0x80) BasicRateBitmap |= 0x0080;
            break;
        case 48:
        ...
        case 72:
            Rate = RATE_36;
            if (pSupRate[i] & 0x80) BasicRateBitmap |= 0x0200;
            break;
        case 96:
            Rate = RATE_48;
            if (pSupRate[i] & 0x80) BasicRateBitmap |= 0x0400;
            break;
        case 108:
            Rate = RATE_54;
            if (pSupRate[i] & 0x80) BasicRateBitmap |= 0x0800;
            break;
        default:
            Rate = RATE_1;
            break;
    ...
    for (i=0; i<ExtRateLen; i++)
    {
        ...
        case 2:
            Rate = RATE_1;
            if (pExtRate[i] & 0x80) BasicRateBitmap |= 0x0001;
            break;
        case 4:
            Rate = RATE_2;
            if (pExtRate[i] & 0x80) BasicRateBitmap |= 0x0002;
            break;
        case 11:
            Rate = RATE_5_5;
            if (pExtRate[i] & 0x80) BasicRateBitmap |= 0x0004;
            break;
        case 22:
            Rate = RATE_11;
            if (pExtRate[i] & 0x80) BasicRateBitmap |= 0x0008;
            break;
        case 12:
        ...
        case 18:
            Rate = RATE_9;
            if (pExtRate[i] & 0x80) BasicRateBitmap |= 0x0020;
            break;
        case 24:
        ...
        case 36:
            Rate = RATE_18;
            if (pExtRate[i] & 0x80) BasicRateBitmap |= 0x0080;
            break;
        case 48:
        ...
        case 72:
            Rate = RATE_36;
            if (pExtRate[i] & 0x80) BasicRateBitmap |= 0x0200;
            break;
        case 96:
            Rate = RATE_48;
            if (pExtRate[i] & 0x80) BasicRateBitmap |= 0x0400;
            break;
        case 108:
            Rate = RATE_54;
            if (pExtRate[i] & 0x80) BasicRateBitmap |= 0x0800;
            break;
        default:
            Rate = RATE_1;
            break;
